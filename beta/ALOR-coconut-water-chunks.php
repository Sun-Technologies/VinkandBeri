...
<html>
<head>
  <title>Vink &amp; Beri LLC | ALOR Coconut Water with Coconut Chunks</title>
...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      ...
      <li class="active">ALOR Coconut Water with Coconut Chunks</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
...
<div id="main" class="page">
  <header class="page-header">
    <div class="container">
      <h1 class="title">ALOR Coconut Water with Coconut Chunks</h1>
    </div>	
  </header>
		  ...
		  <div class="span5">
			<div class="image-box">
			  <div class="general-img">
				<img alt="" src="img/content/coconut_chunks_latest11.png" data-zoom-image="img/content/coconut_chunks_latest11.png" width="700" height="700">
			  </div><!-- .general-img -->
