...
<head>
  <title>Under Construction \ Progressive — Responsive Multipurpose HTML Template</title>
  ...
  <div class="container">
    <div class="row">
      <div class="text-center span12">
		<h4>We are currently under construction!</h4>
		<p>
		  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus mi urna, vehicula aliquam dapibus ornare, semper semper nisl. Duis tristique purus sit amet libero condimentum id consequat sem vehicula.  Donec ultricies nunc ac nulla sodales ac imperdiet purus euismod. Sed porta ante auctor accumsan.
		</p>
		<br><hr><br>
	  </div>
	  
	  <div class="span4 coming-text">
		<form>
		  <input class="input-block-level" type="email" placeholder="Enter your email address…">
		  <button type="submit" class="btn">Join Us</button>
		</form>
	  </div>
	  
	  <div class="under-contact">
		<div class="offset1 span3 phone">
		  ...
		  <strong>Call Us:</strong> +1 (877) 123-45-67 <br>
		  ...
		  <div class="footer-icon">
			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			  ...
			  <g>
				...
				<g>
				  <circle fill="#1e1e1e" cx="8.001" cy="6" r="2"/>
				</g>
			  </g>
			</svg>
		  </div>
