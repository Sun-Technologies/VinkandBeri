...
<html>
<head>
  <title>FAQ \ Progressive — Responsive Multipurpose HTML Template</title>
    ...
    <div class="row">
      <article class="content span12">
		...
		<div class="filter-box accordions-filter">
		  ...
		  <div class="accordion filter-elements" id="accordion2">
			<div class="accordion-group web-design">
			  ...
			  <p>Maecenas commodo tincidunt mauris, eleifend molestie lacus congue et. Vivamus egestas hendrerit massa, ac congue ligula sollicitudin quis. Morbi aliquam nibh eget nisi rhoncus pharetra. Integer nibh dui, vehicula non iaculis at, tempus ac enim. Cras congue, elit nec ornare egestas, magna nunc sollicitudin velit, nec lobortis erat urna vitae metus. Mauris convallis faucibus pellentesque. Proin faucibus hendrerit magna, in pharetra dui varius nec.</p>
			  <p>Mauris scelerisque posuere egestas. Nullam ut diam felis, vel faucibus sapien. Duis quam libero, mollis vel egestas eget, tristique sit amet nisi. Duis luctus rutrum sagittis. Mauris auctor purus sit amet orci pharetra vitae rhoncus libero eleifend. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. In vehicula lectus vitae nunc pretium placerat. Aenean a ante non nisi tristique luctus eu nec nunc. Aliquam lacinia elit at felis bibendum blandit. Nunc fringilla massa vel augue aliquam blandit. Phasellus eget lectus purus, non blandit enim. Etiam porta nibh nec enim pharetra et tempus mauris iaculis.</p>
			  <ol>
			...
			<div class="accordion-group graphic-design">
			  <div class="accordion-heading">
			...
			<div class="accordion-group ecommerce">
			  <div class="accordion-heading">
