//<![CDATA[
   ...
   function searchLocationsNear(center) {
    ...
    function createOption(name, distance, num, address, lat , lng) {
      ...
      option.innerHTML = "<div id=location-area>" + "<a href='" + jscript + "'><b>" + name + "(" + distance.toFixed(1) + " mi)"  + "</b></a><br/>" + address + "<br/><a href='https://maps.google.com/?saddr="+addressInput.value+"&daddr="+address+"' target='_blank' id='get-location'>Get Directions <i class=icon-arrow-right></i></a>" + "</div>";
      locationSelect.appendChild(option);
    }
