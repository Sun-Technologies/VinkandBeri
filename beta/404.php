...
<?php include 'header.php'; ?><!-- .header --><div class="breadcrumb-box">  <div class="container">    <ul class="breadcrumb">      <li><a href="index.html">Home</a> <span class="divider">/</span></li>      <li class="active">404 Not Found</li>    </ul>	  </div></div><!-- .breadcrumb-box -->
