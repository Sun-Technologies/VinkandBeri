      ...
      <div class="content span12">
		<div class="row">
		  ...
		  <div class="span6">
			...
			<ul>
			  <li><a href="index.php">Go to</a> to Home page.</li>
			  <li>Visit our products. Follow these links to get you back on track!</li>
			</ul>
		  </div>
		</div>
      </div>
